...
public class AdlibTestProjectActivity9 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		_amanager.loadNativeAd(1, ContentType.ALL, 20, new AdlibNativeAdListener(){
			@Override
			public void onReceiveAd(ArrayList<AdlibNativeItem> items) {
				Log.d("ADLIB-Native", "onReceiveAd ::: item size : " + items.size());
				
				AdlibNativeLayout anl = new AdlibNativeLayout(AdlibTestProjectActivity9.this, R.layout.main9_item, layout);
				anl.setAdsData(items.get(0));
